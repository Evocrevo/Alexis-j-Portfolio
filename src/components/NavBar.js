...
const NavBar = () => {
    ...
    return (
        ...
        dark:text-primaryDark relative z-10 lg:px-16 md:px-12 sm:px-8'>
            ...
            <div className='w-full flex justify-between items-center lg:hidden'>
                ...
                <nav className='flex items-center justify-center flex-wrap'>
                    <motion.a href="https://github.com/Evocrevo" target={'_blank'}
                        whileHover={{ y: -2 }}
                        whileTap={{ scale: 0.9 }}
                        className='w-6 mx-3'>
                        <GithubIcon />
                    </motion.a>
                    <motion.a href="www.linkedin.com/in/john-alexis-abres-58043320a" target={'_blank'}
                        whileHover={{ y: -2 }}
                        whileTap={{ scale: 0.9 }}
                        className='w-6 mx-3'>
                        <LinkedInIcon />
                    </motion.a>
                    <motion.a href="https://www.facebook.com/profile.php?id=100087492764556" target={'_blank'}
                        whileHover={{ y: -2 }}
                        whileTap={{ scale: 0.9 }}
                        className='w-6 ml-3'>
                        <FacebookIcon />
                ...
                ${mode === "dark" ? "bg-primaryDark text-dark" : "bg-dark text-light"}`}>
                        {
                            mode === "light" ?
            ...
            bg-primary/90 dark:bg-dark/75 rounded-lg backdrop-blur-md py-32'>
